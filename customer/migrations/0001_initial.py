# Generated by Django 4.2.7 on 2024-04-18 10:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='desc_pro',
            fields=[
                ('desc_id', models.AutoField(db_column='Product_id', primary_key=True, serialize=False)),
                ('desc_price', models.IntegerField(blank=True, db_column='desc_price', null=True)),
            ],
            options={
                'db_table': 'desc_pro',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emp_un', models.CharField(blank=True, max_length=30, null=True)),
                ('emp_password', models.CharField(blank=True, max_length=10, null=True)),
            ],
            options={
                'db_table': 'employee',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('o_state', models.CharField(blank=True, max_length=10, null=True)),
            ],
            options={
                'db_table': 'order1',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default=' ', upload_to='productimg/')),
                ...
                ('product_color', models.CharField(blank=True, db_column='Product_color', max_length=30, null=True)),
                ('dc_price', models.IntegerField(blank=True, db_column='dc_price', null=True)),
                ('dk_price', models.IntegerField(blank=True, db_column='product_discount', null=True)),
            ],
            options={
                'db_table': 'product',
                'managed': False,
        ...
        migrations.CreateModel(
            name='Production',
            fields=[
                ('production_id', models.AutoField(db_column='Production_id', primary_key=True, serialize=False)),
                ('quantity', models.IntegerField(db_column='Quantity')),
                ('production_cost', models.FloatField(db_column='Production_cost')),
                ('production_date', models.DateField(db_column='Production_date')),
                ('polymer', models.CharField(blank=True, db_column='Polymer', max_length=50, null=True)),
                ('p_quantity', models.CharField(blank=True, db_column='P_quantity', max_length=10, null=True)),
                ('other_material', models.CharField(blank=True, db_column='Other_material', max_length=30, null=True)),
                ('m_quantity', models.CharField(blank=True, db_column='M_quantity', max_length=10, null=True)),
            ],
            options={
                'db_table': 'production',
                'managed': False,
        ...
        migrations.CreateModel(
            name='RawMaterial',
            fields=[
                ('raw_id', models.AutoField(db_column='Raw_id', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Sales',
            fields=[
                ('sales_id', models.AutoField(db_column='Sales_id', primary_key=True, serialize=False)),
